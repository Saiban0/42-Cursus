...
/*   Updated: 2023/08/20 13:47:30 by echapuis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (constraints_valid(colup, coldown, rowleft, rowright))
	{
		...
		ft_remplissage_bete_coldown(plateau, coldown);
		ft_remplissage_bete_colup(plateau, colup);
		ft_remplissage_bete_rowleft(plateau, rowleft);
		ft_remplissage_bete_rowright(plateau, rowright);
		write(1, "\n", 1);
		debug(plateau, colup, coldown, rowleft, rowright);
